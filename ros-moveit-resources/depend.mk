...
ROS_MOVEIT_RESOURCES_DEPEND_MK:=	${ROS_MOVEIT_RESOURCES_DEPEND_MK}+

ifeq (+,$(DEPEND_DEPTH))
DEPEND_PKG+=		ros-moveit-resources
endif

ifeq (+,$(ROS_MOVEIT_RESOURCES_DEPEND_MK)) # --------------------------------------
...
DEPEND_ABI.ros-moveit-resources?=	ros-moveit-resources>=0.6.4
...
endif # ROS_MOVEIT_RESOURCES_DEPEND_MK --------------------------------------------
