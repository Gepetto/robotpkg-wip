...
ROS_OCTOMAP_MSGS_DEPEND_MK:=	${ROS_OCTOMAP_MSGS_DEPEND_MK}+

ifeq (+,$(DEPEND_DEPTH))
DEPEND_PKG+=		ros-octomap-msgs
endif

ifeq (+,$(ROS_OCTOMAP_MSGS_DEPEND_MK)) # --------------------------------------
...
DEPEND_ABI.ros-octomap-msgs?=		ros-octomap-msgs>=0.3.3
...
endif # ROS_OCTOMAP_MSGS_DEPEND_MK --------------------------------------------
